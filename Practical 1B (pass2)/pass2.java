...
public static void main(String[] Args) throws IOException{
	...
	FileReader("C:\\Users\\banka\\Desktop\\cns\\SPOS\\src\\intermediate.txt"));
	BufferedReader b2 = new BufferedReader(new FileReader("C:\\Users\\banka\\Desktop\\cns\\SPOS\\src\\symtab.txt"));
	BufferedReader b3 = new BufferedReader(new FileReader("C:\\Users\\banka\\Desktop\\cns\\SPOS\\src\\littab.txt"));
	FileWriter f1 = new FileWriter("C:\\Users\\banka\\Desktop\\Pass2.txt");
	...
	litAddr.put(littabPointer++,word[0]);
}
...
b2.close();
b3.close();
System.out.println("pass2 completed successfully");
}
}