...
public class pass2 
{
	...
	{
		BufferedReader b1 = new BufferedReader(new FileReader("E:\\temp\\intermediate.txt"));
		
		BufferedReader b2 = new BufferedReader(new FileReader("E:\\temp\\symtab.txt"));
		
		BufferedReader b3 = new BufferedReader(new FileReader("E:\\temp\\littab.txt"));
		
		
		FileWriter f1 = new FileWriter("E:\\temp\\Pass2.txt");
