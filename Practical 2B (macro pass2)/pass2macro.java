...
class pass2macro
	{ 
		...
		{ 
			String s = new String(); 
			input = new BufferedReader(new InputStreamReader(new  FileInputStream("E:\\temp\\macro2\\input.txt"))); 
			PrintWriter output = new PrintWriter(new FileOutputStream("E:\\temp\\macro2\\output_pass1.txt"), true); 
		...
		{ 
			...
			String macro_name = s.substring(0, s.indexOf(" ")); mnt.add(new MntTuple(macro_name, mdtc)); 
			mntc++; 
			pass1Ala(s); 
			StringTokenizer st = new StringTokenizer(s, " ,", false); String x = st.nextToken(); 
		...
		{ 
			StringTokenizer st = new StringTokenizer(s, " ,", false); String macro_name = st.nextToken(); 
		...
		{ 
			...
			FileOutputStream("out_ala_pass" + pass + ".txt"), true); for(List l : ala) { 
		...
		{ 
			input = new BufferedReader(new InputStreamReader(new FileInputStream("E://temp//macro2//output_pass1.txt"))); //INPUT FILE AND PATH
			
			PrintWriter output = new PrintWriter(new FileOutputStream("E://temp//macro2//output_pass2.txt"), true);  //OUTPUT FILE PATH
		...
		{ 
			StringTokenizer st = new StringTokenizer(s, " ", false); int num_tokens = st.countTokens(); 
			...
			try
			{ 
				st2 = new StringTokenizer(st.nextToken(), ",", false); while(st2.hasMoreTokens()) { 
